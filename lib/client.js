...
try {
    ...
    console.log("🌍 Connected to the DARK  DB")
} catch {
...
let cc = Config.sessionName.replace(/VAJIRA;;;/g, "").replace(/IZUKU;;;/gi, ""); // DONT REMOVE BLACK;;; so you can connect BLACK md session id too
